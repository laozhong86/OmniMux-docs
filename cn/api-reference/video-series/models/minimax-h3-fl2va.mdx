---
title: "MiniMax 图生视频"
sidebarTitle: "MiniMax 图生视频"
description: "MiniMax 图生视频 · model `minimax-h3-fl2va`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `minimax-h3-fl2va`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `minimax-h3-fl2va` |
