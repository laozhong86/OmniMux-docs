---
title: "MiniMax 首尾帧"
sidebarTitle: "MiniMax 首尾帧"
description: "MiniMax 首尾帧 · model `minimax-h3-flf`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `minimax-h3-flf`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `minimax-h3-flf` |
