---
title: "MiniMax 尾帧"
sidebarTitle: "MiniMax 尾帧"
description: "MiniMax 尾帧 · model `minimax-h3-endframe`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `minimax-h3-endframe`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `minimax-h3-endframe` |
