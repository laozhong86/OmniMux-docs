---
title: "Omni Flash 4 秒"
sidebarTitle: "Omni Flash 4 秒"
description: "Omni Flash 4 秒 · model `omni_flash-4s`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `omni_flash-4s`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `omni_flash-4s` |
