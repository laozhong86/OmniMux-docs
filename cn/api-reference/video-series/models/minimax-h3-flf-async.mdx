---
title: "MiniMax 首尾帧 · 异步"
sidebarTitle: "MiniMax 首尾帧 · 异步"
description: "MiniMax 首尾帧 · 异步 · model `minimax-h3-flf-async`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `minimax-h3-flf-async`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `minimax-h3-flf-async` |
