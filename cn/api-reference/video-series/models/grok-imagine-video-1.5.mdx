---
title: "Grok Imagine 视频生成"
sidebarTitle: "Grok Imagine 视频生成"
description: "Grok Imagine 视频生成 · model `grok-imagine-video-1.5`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `grok-imagine-video-1.5`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `grok-imagine-video-1.5` |
