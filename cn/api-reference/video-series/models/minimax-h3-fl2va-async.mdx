---
title: "MiniMax 图生视频 · 异步"
sidebarTitle: "MiniMax 图生视频 · 异步"
description: "MiniMax 图生视频 · 异步 · model `minimax-h3-fl2va-async`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `minimax-h3-fl2va-async`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `minimax-h3-fl2va-async` |
...
轮询字段见 [查询视频任务](/cn/api-reference/tasks/video-task)。错误见右栏与 [错误码](/cn/faqs/connection-usage)。
