---
title: "MiniMax 文生视频"
sidebarTitle: "MiniMax 文生视频"
description: "MiniMax 文生视频 · model `minimax-h3-t2v`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `minimax-h3-t2v`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `minimax-h3-t2v` |
