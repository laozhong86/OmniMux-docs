---
title: "LTX 视频生成 · 异步"
sidebarTitle: "LTX 视频生成 · 异步"
description: "LTX 视频生成 · 异步 · model `ltx2.3-kj-async`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `ltx2.3-kj-async`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `ltx2.3-kj-async` |
