---
title: "Nano Banana Pro 生图"
sidebarTitle: "Nano Banana Pro 生图"
description: "Nano Banana Pro 生图 · model `nano_banana_pro`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- 调用 `POST /v1/images/generations`，`model` 为 `nano_banana_pro`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `nano_banana_pro` |
