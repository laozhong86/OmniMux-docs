...
<a id="2026-09-22-deepseek-flash"></a>

<Update label="2026 年 9 月 22 日" tags={["新模型", "文本"]} rss={{ title: "DeepSeek Flash（deepseek-flash）正式上线" }}>

  ## 本次更新

  - **官方现网正式编号**：OmniMux 上线 `deepseek-flash`（DeepSeek-V4.1-Flash）。官方已下线的旧编号 `deepseek-v4-flash` 与 `deepseek-v4-flash-vision-exp` 上游仍可受理，但实际由本模型承接。
  - **长上下文与图像理解**：1M 上下文窗口、最大 384K 输出、图像理解、JSON 输出、工具调用，并同时支持思考与非思考模式。
  - **缓存单独计价**：缓存命中按官方缓存价单独计费，长提示词重复调用成本显著更低。
  - **官方 6 折定价**：以官方零售标价为基准，按模型专属分组（`deepseek-flash-economy`，倍率 0.6）折算售价——空闲时段输入 0.6 元、输出 2.4 元、缓存命中 0.012 元每百万词元；北京时间周一至周五 9:00-12:00 与 14:00-18:00 高峰时段按官方规则翻倍。
  ...
  - DeepSeek 完整参数手册：`/zh/api-reference/text-series/deepseek/complete`
...
<a id="2026-09-18-gpt-image-tiers"></a>

<Update label="2026 年 9 月 18 日" tags={["新模型", "图像"]} rss={{ title: "GPT Image 2.5 Flare 与 Sunburst 档位路由上线" }}>
  ...
  - [GPT Image 接口文档](/zh/api-reference/image-series/gpt-image/generate)

</Update>

<a id="2026-09-18-video-task-models"></a>

<Update label="2026 年 9 月 18 日" tags={["新模型", "视频"]} rss={{ title: "视频按次生成任务通道与 H3 衍生变体模型上线" }}>
  ...
  - [Seedance 2.0 接口文档](/zh/api-reference/video-series/models/seedance-2-0)
  - [MiniMax H3 接口文档](/zh/api-reference/video-series/models/minimax-h3)

</Update>

<a id="2026-09-18-volc-doubao-asr"></a>

<Update label="2026 年 9 月 18 日" tags={["新模型", "音频"]} rss={{ title: "豆包语音识别大模型系列接口上线" }}>
  ...
  - [豆包语音识别文档](/zh/api-reference/audio-series/models/doubao-asr)

</Update>

<a id="2026-09-18-volc-seed-audio"></a>

<Update label="2026 年 9 月 18 日" tags={["新模型", "音频"]} rss={{ title: "火山引擎 Seed Audio (seed-audio-1.0) 语音生成接口上线" }}>
  ...
  - [Seed Audio 接口文档](/zh/api-reference/audio-series/models/seed-audio)

</Update>

<a id="2026-09-18-indextts-2"></a>

<Update label="2026 年 9 月 18 日" tags={["新模型", "音频"]} rss={{ title: "Index TTS 声音克隆 (indextts-2) 接口上线" }}>
  ...
  - [Index TTS 接口参考](/zh/api-reference/audio-series/models/index-tts)

</Update>

<a id="2026-09-18-suno-sounds"></a>

<Update label="2026 年 9 月 18 日" tags={["新模型", "音频"]} rss={{ title: "Suno 独立音效生成接口 (suno-sounds) 上线" }}>
  ...
  - [Suno 接口文档](/zh/api-reference/audio-series/models/suno)

</Update>

<a id="2026-09-18-gemini-3-8-flash"></a>

<Update label="2026 年 9 月 18 日" tags={["新模型", "文本"]} rss={{ title: "Gemini 3.8 Flash 对话补全接口上线" }}>
  ...
  - [Gemini 完整参数参考](/zh/api-reference/text-series/gemini/complete)

</Update>

<a id="2026-09-18-doubao-seed-evolving"></a>

<Update label="2026 年 9 月 18 日" tags={["新模型", "文本"]} rss={{ title: "字节跳动火山方舟官方直连大模型 seed-evolving 正式上线" }}>
...
<Update label="2026 年 7 月 30 日" tags={["新模型", "视频"]} rss={{ title: "MiniMax H3 — 文生视频与帧变体" }}>
  ...
  **MiniMax H3** 视频模型现已在 OmniMux 可调用。
  ...
  - [MiniMax H3 视频](/zh/api-reference/video-series/models/minimax-h3)
