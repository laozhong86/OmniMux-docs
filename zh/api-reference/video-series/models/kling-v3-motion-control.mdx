---
title: "Kling V3 运镜控制视频生成"
sidebarTitle: "Kling V3 运镜控制视频生成"
description: "Kling V3 运镜控制视频生成 · model `kling-v3-motion-control`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `kling-v3-motion-control`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `kling-v3-motion-control` |
