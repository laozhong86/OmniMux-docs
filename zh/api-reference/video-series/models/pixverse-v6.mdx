---
title: "PixVerse v6 视频生成"
sidebarTitle: "PixVerse v6 视频生成"
description: "PixVerse v6 视频生成 · model `pixverse-v6`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `pixverse-v6`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `pixverse-v6` |
