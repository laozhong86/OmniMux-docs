...
sidebarTitle: "Wan 3.0 Prime 参考生视频"
description: "Wan 3.0 Prime 参考生视频 · model `wan-3.0-prime-ref`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `wan-3.0-prime-ref`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `wan-3.0-prime-ref` |
