---
title: "Seedance 2.0 Mini 视频生成"
sidebarTitle: "Seedance 2.0 Mini 视频生成"
description: "Seedance 2.0 Mini 视频生成 · model `seedance-2-0-mini`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `seedance-2-0-mini`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `seedance-2-0-mini` |
