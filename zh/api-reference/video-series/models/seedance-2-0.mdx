...
sidebarTitle: "Seedance 2.0 视频生成"
description: "Seedance 2.0 视频生成 · model `seedance-2-0`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 可选 `seedance-2-0`（标准通道）或 `seedance-2-0-task`（按次任务固定计费通道）
