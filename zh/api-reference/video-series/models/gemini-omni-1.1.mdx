---
title: "Omni 1.1 视频生成"
sidebarTitle: "Omni 1.1 视频生成"
description: "Omni 1.1 视频生成 · model `gemini-omni-1.1`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `gemini-omni-1.1`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `gemini-omni-1.1` |
