---
title: "Veo 3.1 Fast 视频生成"
sidebarTitle: "Veo 3.1 Fast 视频生成"
description: "Veo 3.1 Fast 视频生成 · model `veo-3.1-fast`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `veo-3.1-fast`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `veo-3.1-fast` |
