---
title: "Seedance 2.0 Fast 视频生成"
sidebarTitle: "Seedance 2.0 Fast 视频生成"
description: "Seedance 2.0 Fast 视频生成 · model `seedance-2-0-fast`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `seedance-2-0-fast`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `seedance-2-0-fast` |
