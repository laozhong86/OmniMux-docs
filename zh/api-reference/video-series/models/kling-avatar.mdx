---
title: "Kling Avatar 视频生成"
sidebarTitle: "Kling Avatar 视频生成"
description: "Kling Avatar 视频生成 · model `kling-avatar`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `kling-avatar`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `kling-avatar` |
