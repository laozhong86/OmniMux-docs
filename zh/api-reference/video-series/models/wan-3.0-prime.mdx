---
title: "Wan 3.0 Prime 视频生成"
sidebarTitle: "Wan 3.0 Prime 视频生成"
description: "Wan 3.0 Prime 视频生成 · model `wan-3.0-prime`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- 创建：`POST /v1/video/generations`，`model` 为 `wan-3.0-prime`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `wan-3.0-prime` |
