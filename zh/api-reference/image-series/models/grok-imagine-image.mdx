---
title: "Grok Imagine 生图"
sidebarTitle: "Grok Imagine 生图"
description: "Grok Imagine 生图 · model `grok-imagine-image`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- 调用 `POST /v1/images/generations`，`model` 为 `grok-imagine-image`
