---
title: "Grok Imagine Image Quality 生图"
sidebarTitle: "Grok Imagine Image Quality 生图"
description: "Grok Imagine Image Quality 生图 · model `grok-imagine-image-quality`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- 调用 `POST /v1/images/generations`，`model` 为 `grok-imagine-image-quality`
