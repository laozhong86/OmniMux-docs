---
title: "Grok Imagine Image 2.0 生图"
sidebarTitle: "Grok Imagine Image 2.0 生图"
description: "Grok Imagine Image 2.0 生图 · model `grok-imagine-image-2.0`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- 调用 `POST /v1/images/generations`，`model` 为 `grok-imagine-image-2.0`
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定为 `grok-imagine-image-2.0` |
