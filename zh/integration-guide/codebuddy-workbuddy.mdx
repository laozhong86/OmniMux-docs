...
OmniMux 支持 OpenAI、Anthropic、Google 等多家厂商的模型。可用模型见控制台、`GET /v1/models`，或 [Claude · 完整参数](/zh/api-reference/text-series/claude/complete) 等语言合同页。
...
* [OmniMux 控制台](https://omnimux.ai/dashboard)
* [CodeBuddy 官方文档](https://www.codebuddy.cn/docs)
* [OmniMux API 文档](/zh/api-reference/text-series/claude/complete)
