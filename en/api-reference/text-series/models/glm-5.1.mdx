...
````yaml openapi/ops/chat/glm-5.1.json POST /v1/chat/completions
openapi: 3.1.0
info:
  title: glm-5.1 · Chat Completions
  description: OpenAI-compatible Chat Completions for `glm-5.1` (GLM) on OmniMux gateway.
  version: 1.0.0
servers:
...
paths:
  /v1/chat/completions:
    post:
      tags:
      - Chat Completion
      summary: glm-5.1 Chat Completions
      description: '- OpenAI Chat Completions protocol

        - Select model via body `model` = `glm-5.1`

        - Synchronous by default; set `stream: true` for SSE

        - Multimodal / tools fields per gateway schema when supported'
      operationId: createChatCompletion_glm_5_1
      requestBody:
        required: true
        content:
          application/json:
  ...
  schemas:
    ChatCompletionRequest:
      ...
      properties:
        model:
          type: string
          description: Model id. This page pins `glm-5.1`.
          enum:
          - glm-5.1
          default: glm-5.1
          example: glm-5.1
