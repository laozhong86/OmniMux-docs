...
````yaml openapi/ops/chat/kimi-k2.6.json POST /v1/chat/completions
openapi: 3.1.0
info:
  title: kimi-k2.6 · Chat Completions
  description: OpenAI-compatible Chat Completions for `kimi-k2.6` (Kimi) on OmniMux gateway.
  version: 1.0.0
servers:
...
paths:
  /v1/chat/completions:
    post:
      tags:
      - Chat Completion
      summary: kimi-k2.6 Chat Completions
      description: '- OpenAI Chat Completions protocol

        - Select model via body `model` = `kimi-k2.6`

        - Synchronous by default; set `stream: true` for SSE

        - Multimodal / tools fields per gateway schema when supported'
      operationId: createChatCompletion_kimi_k2_6
      requestBody:
        required: true
        content:
          application/json:
  ...
  schemas:
    ChatCompletionRequest:
      ...
      properties:
        model:
          type: string
          description: Model id. This page pins `kimi-k2.6`.
          enum:
          - kimi-k2.6
          default: kimi-k2.6
          example: kimi-k2.6
