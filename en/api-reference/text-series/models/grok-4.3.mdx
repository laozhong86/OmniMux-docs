...
````yaml openapi/ops/chat/grok-4.3.json POST /v1/chat/completions
openapi: 3.1.0
info:
  title: grok-4.3 · Chat Completions
  description: OpenAI-compatible Chat Completions for `grok-4.3` (Grok) on OmniMux gateway.
  version: 1.0.0
servers:
...
paths:
  /v1/chat/completions:
    post:
      tags:
      - Chat Completion
      summary: grok-4.3 Chat Completions
      description: '- OpenAI Chat Completions protocol

        - Select model via body `model` = `grok-4.3`

        - Synchronous by default; set `stream: true` for SSE

        - Multimodal / tools fields per gateway schema when supported'
      operationId: createChatCompletion_grok_4_3
      requestBody:
        required: true
        content:
          application/json:
  ...
  schemas:
    ChatCompletionRequest:
      ...
      properties:
        model:
          type: string
          description: Model id. This page pins `grok-4.3`.
          enum:
          - grok-4.3
          default: grok-4.3
          example: grok-4.3
