---
title: "Claude · Complete API Reference"
sidebarTitle: "Claude · Complete API Reference"
description: "Claude · Chat Completions complete API reference (shared contract, model enum)"
