---
title: "Grok Imagine Image Generation · Quality"
sidebarTitle: "Grok Imagine Image Generation · Quality"
description: "Grok Imagine Image Generation · Quality · model `grok-imagine-image-quality`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- Call `POST /v1/images/generations` with `model` `grok-imagine-image-quality`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `grok-imagine-image-quality` |
...
```bash curl --request POST \
  ...
  --data '{"model":"grok-imagine-image-quality","prompt":"a product photo on white background","n":1}'
```
