---
title: "GPT Image HD Generation"
sidebarTitle: "GPT Image HD Generation"
description: "GPT Image HD Generation · model `gpt-image-2-hd`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- Call `POST /v1/images/generations` with `model` `gpt-image-2-hd`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `gpt-image-2-hd` |
...
```bash curl --request POST \
  ...
  --data '{"model":"gpt-image-2-hd","prompt":"a product photo on white background","n":1}'
```
