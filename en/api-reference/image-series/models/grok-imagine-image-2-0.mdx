...
sidebarTitle: "Grok Imagine Image 2.0 Image Generation"
description: "Grok Imagine Image 2.0 Image Generation · model `grok-imagine-image-2-0`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- Call `POST /v1/images/generations` with `model` `grok-imagine-image-2-0`
...
```bash curl --request POST \
  ...
  --data '{"model":"grok-imagine-image-2-0","prompt":"a product photo on white background","n":1}'
```
