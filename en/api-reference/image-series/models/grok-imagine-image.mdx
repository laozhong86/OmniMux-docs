...
sidebarTitle: "Grok Imagine Image Generation"
description: "Grok Imagine Image Generation · model `grok-imagine-image`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- Call `POST /v1/images/generations` with `model` `grok-imagine-image`
...
```bash curl --request POST \
  ...
  --data '{"model":"grok-imagine-image","prompt":"a product photo on white background","n":1}'
```
