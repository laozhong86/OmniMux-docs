...
sidebarTitle: "GPT Image Generation"
description: "GPT Image Generation · model `gpt-image2`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- Call `POST /v1/images/generations` with `model` `gpt-image2`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `gpt-image2` |
