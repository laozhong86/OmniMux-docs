...
sidebarTitle: "Nano Banana 2 Image Generation"
description: "Nano Banana 2 Image Generation · model `nano_banana_2`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- Call `POST /v1/images/generations` with `model` `nano_banana_2`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `nano_banana_2` |
