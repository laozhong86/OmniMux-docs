...
sidebarTitle: "GPT Image 2 Generation"
description: "GPT Image 2 Generation · model `gpt-image-2`"
api: "POST https://api.omnimux.ai/v1/images/generations"
---

- Call `POST /v1/images/generations` with `model` `gpt-image-2`
...
```bash curl --request POST \
  ...
  --data '{"model":"gpt-image-2","prompt":"a product photo on white background","n":1}'
```
