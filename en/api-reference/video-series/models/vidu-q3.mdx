...
sidebarTitle: "Vidu Q3 Video Generation"
description: "Vidu Q3 Video Generation · model `vidu-q3`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `vidu-q3`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `vidu-q3` |
...
```bash curl --request POST \
  ...
  --data '{"model":"vidu-q3","prompt":"slow pan across a product on a table"}'
```
