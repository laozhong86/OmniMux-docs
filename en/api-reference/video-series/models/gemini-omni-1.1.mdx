---
title: "Omni 1.1 Video Generation"
sidebarTitle: "Omni 1.1 Video Generation"
description: "Omni 1.1 Video Generation · model `gemini-omni-1.1`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `gemini-omni-1.1`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `gemini-omni-1.1` |
...
```bash curl --request POST \
  ...
  --data '{"model":"gemini-omni-1.1","prompt":"slow pan across a product on a table"}'
```
