---
title: "Omni Flash 10s"
sidebarTitle: "Omni Flash 10s"
description: "Omni Flash 10s · model `omni_flash-10s`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `omni_flash-10s`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `omni_flash-10s` |
