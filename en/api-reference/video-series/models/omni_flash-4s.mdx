---
title: "Omni Flash 4s"
sidebarTitle: "Omni Flash 4s"
description: "Omni Flash 4s · model `omni_flash-4s`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `omni_flash-4s`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `omni_flash-4s` |
