---
title: "MiniMax End Frame · Async"
sidebarTitle: "MiniMax End Frame · Async"
description: "MiniMax End Frame · Async · model `minimax-h3-endframe-async`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `minimax-h3-endframe-async`
...
| Series | Video series |
| Brand | MiniMax |
| model | `minimax-h3-endframe-async` |
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `minimax-h3-endframe-async` |
