---
title: "MiniMax text-to-video async"
sidebarTitle: "MiniMax text-to-video async"
description: "MiniMax text-to-video async · model `minimax-h3-t2v-async`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `minimax-h3-t2v-async`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `minimax-h3-t2v-async` |
