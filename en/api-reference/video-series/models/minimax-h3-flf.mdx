---
title: "MiniMax First-Last Frame"
sidebarTitle: "MiniMax First-Last Frame"
description: "MiniMax First-Last Frame · model `minimax-h3-flf`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `minimax-h3-flf`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `minimax-h3-flf` |
...
```bash curl --request POST \
  ...
  --data '{"model":"minimax-h3-flf","prompt":"slow pan across a product on a table"}'
```
