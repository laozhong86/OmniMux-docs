---
title: "LTX Video Generation · Async"
sidebarTitle: "LTX Video Generation · Async"
description: "LTX Video Generation · Async · model `ltx2.3-kj-async`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `ltx2.3-kj-async`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `ltx2.3-kj-async` |
