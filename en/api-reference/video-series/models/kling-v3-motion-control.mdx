---
title: "Kling V3 Motion Control Video Generation"
sidebarTitle: "Kling V3 Motion Control Video Generation"
description: "Kling V3 Motion Control Video Generation · model `kling-v3-motion-control`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `kling-v3-motion-control`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `kling-v3-motion-control` |
...
```bash curl --request POST \
  ...
  --data '{"model":"kling-v3-motion-control","prompt":"slow pan across a product on a table"}'
```
