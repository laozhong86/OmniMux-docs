...
sidebarTitle: "Kling O3 Video Generation"
description: "Kling O3 Video Generation · model `kling-o3`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `kling-o3`
...
```bash curl --request POST \
  ...
  --data '{"model":"kling-o3","prompt":"slow pan across a product on a table"}'
```
