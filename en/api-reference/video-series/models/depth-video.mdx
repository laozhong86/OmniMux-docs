---
title: "Depth Video Generation"
sidebarTitle: "Depth Video Generation"
description: "Depth Video Generation · model `depth-video`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `depth-video`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `depth-video` |
...
```bash curl --request POST \
  ...
  --data '{"model":"depth-video","prompt":"slow pan across a product on a table"}'
```
