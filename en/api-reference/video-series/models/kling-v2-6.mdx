...
sidebarTitle: "Kling V2.6 Video Generation"
description: "Kling V2.6 Video Generation · model `kling-v2-6`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `kling-v2-6`
...
```bash curl --request POST \
  ...
  --data '{"model":"kling-v2-6","prompt":"slow pan across a product on a table"}'
```
