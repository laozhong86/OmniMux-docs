---
title: "Kling Avatar Video Generation"
sidebarTitle: "Kling Avatar Video Generation"
description: "Kling Avatar Video Generation · model `kling-avatar`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `kling-avatar`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `kling-avatar` |
...
```bash curl --request POST \
  ...
  --data '{"model":"kling-avatar","prompt":"slow pan across a product on a table"}'
```
