---
title: "PixVerse v6 Video Generation"
sidebarTitle: "PixVerse v6 Video Generation"
description: "PixVerse v6 Video Generation · model `pixverse-v6`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `pixverse-v6`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `pixverse-v6` |
...
```bash curl --request POST \
  ...
  --data '{"model":"pixverse-v6","prompt":"slow pan across a product on a table"}'
```
