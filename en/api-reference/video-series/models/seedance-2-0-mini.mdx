---
title: "Seedance 2.0 Mini Video Generation"
sidebarTitle: "Seedance 2.0 Mini Video Generation"
description: "Seedance 2.0 Mini Video Generation · model `seedance-2-0-mini`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `seedance-2-0-mini`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `seedance-2-0-mini` |
...
```bash curl --request POST \
  ...
  --data '{"model":"seedance-2-0-mini","prompt":"slow pan across a product on a table"}'
```
