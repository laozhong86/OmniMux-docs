---
title: "Omni Flash 6s"
sidebarTitle: "Omni Flash 6s"
description: "Omni Flash 6s · model `omni_flash-6s`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `omni_flash-6s`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `omni_flash-6s` |
