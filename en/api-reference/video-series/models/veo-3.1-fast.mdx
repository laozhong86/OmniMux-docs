---
title: "Veo 3.1 Fast Video Generation"
sidebarTitle: "Veo 3.1 Fast Video Generation"
description: "Veo 3.1 Fast Video Generation · model `veo-3.1-fast`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `veo-3.1-fast`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `veo-3.1-fast` |
...
```bash curl --request POST \
  ...
  --data '{"model":"veo-3.1-fast","prompt":"slow pan across a product on a table"}'
```
