---
title: "Wan 3.0 Prime Reference Video Generation"
sidebarTitle: "Wan 3.0 Prime Reference Video Generation"
description: "Wan 3.0 Prime Reference Video Generation · model `wan-3.0-prime-ref`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `wan-3.0-prime-ref`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `wan-3.0-prime-ref` |
...
```bash curl --request POST \
  ...
  --data '{"model":"wan-3.0-prime-ref","prompt":"slow pan across a product on a table"}'
```
