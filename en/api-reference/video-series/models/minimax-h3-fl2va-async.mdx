---
title: "MiniMax image-to-video async"
sidebarTitle: "MiniMax image-to-video async"
description: "MiniMax image-to-video async · model `minimax-h3-fl2va-async`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `minimax-h3-fl2va-async`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `minimax-h3-fl2va-async` |
