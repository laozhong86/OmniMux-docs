---
title: "MiniMax End Frame"
sidebarTitle: "MiniMax End Frame"
description: "MiniMax End Frame · model `minimax-h3-endframe`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `minimax-h3-endframe`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `minimax-h3-endframe` |
...
```bash curl --request POST \
  ...
  --data '{"model":"minimax-h3-endframe","prompt":"slow pan across a product on a table"}'
```
