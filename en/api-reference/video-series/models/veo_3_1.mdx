...
sidebarTitle: "Veo 3.1 Video Generation"
description: "Veo 3.1 Video Generation · model `veo_3_1`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `veo_3_1`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `veo_3_1` |
