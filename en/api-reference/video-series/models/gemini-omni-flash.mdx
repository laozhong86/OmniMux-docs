---
title: "Omni Flash Video Generation"
sidebarTitle: "Omni Flash Video Generation"
description: "Omni Flash Video Generation · model `gemini-omni-flash`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `gemini-omni-flash`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `gemini-omni-flash` |
...
```bash curl --request POST \
  ...
  --data '{"model":"gemini-omni-flash","prompt":"slow pan across a product on a table"}'
```
