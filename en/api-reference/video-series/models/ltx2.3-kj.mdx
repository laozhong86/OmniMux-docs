...
sidebarTitle: "LTX Video Generation"
description: "LTX Video Generation · model `ltx2.3-kj`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `ltx2.3-kj`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `ltx2.3-kj` |
...
```bash curl --request POST \
  ...
  --data '{"model":"ltx2.3-kj","prompt":"slow pan across a product"}'
```
