...
sidebarTitle: "Wan 3.0 Prime Video Generation"
description: "Wan 3.0 Prime Video Generation · model `wan-3.0-prime`"
api: "POST https://api.omnimux.ai/v1/video/generations"
---

- Create: `POST /v1/video/generations` with `model` `wan-3.0-prime`
...
| --- | --- | --- | --- |
| `model` | string | yes | Must be `wan-3.0-prime` |
...
```bash curl --request POST \
  ...
  --data '{"model":"wan-3.0-prime","prompt":"slow pan across a product on a table"}'
```
