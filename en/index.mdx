...
<CardGroup cols={2}>
  ...
  <Card title="Connection and usage" icon="link" href="/en/faqs/connection-usage">
    Base URL, dual credentials, and 401/402/429.
  </Card>
  <Card title="API manual" icon="code" href="/en/api-reference/text-series/claude/complete">
    Language / image / video / social contracts.
  </Card>
  <Card title="Integration guide" icon="plug" href="/en/integration-guide/chatbox">
    Chat apps, dev tools, and app platforms.
  </Card>
</CardGroup>

## For agents

Mintlify auto-hosts machine-readable docs. Point your agent here first:

<CardGroup cols={2}>
  <Card title="llms.txt" icon="list" href="https://docs.omnimux.ai/llms.txt">
    Site index for LLMs — page list with short descriptions (always generated from nav).
  </Card>
  <Card title="llms-full.txt" icon="file-text" href="https://docs.omnimux.ai/llms-full.txt">
    Full-site Markdown dump for one-shot context.
  </Card>
  <Card title="skill.md" icon="sparkles" href="https://docs.omnimux.ai/skill.md">
    Product skill: when to use OmniMux, auth, and common workflows.
  </Card>
  <Card title="Docs MCP" icon="plug" href="https://docs.omnimux.ai/mcp">
    Hosted search MCP for Cursor / Claude / other MCP clients.
  </Card>
</CardGroup>

Tip: any docs page also has a Markdown twin at `…/path.md`, and the page header contextual menu can copy Markdown or install the docs MCP.
