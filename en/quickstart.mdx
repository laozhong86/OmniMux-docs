...
- Access to the [OmniMux console](https://geminix.cc)
...
<Steps>
  <Step title="Create an API key">
    Sign in to the [console](https://geminix.cc), open **Tokens / API Keys**, and create a key.
  ...
  <Step title="Set the Base URL">
    ...
    For OpenAI-compatible SDKs, use `https://geminix.cc/v1` (the SDK appends `/chat/completions`, etc.).
  </Step>
