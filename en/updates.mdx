...
<Update label="September 15, 2026" tags={["Platform"]} rss={{ title: "Upgrade guide: file upload request limits" }}>
  ...
  The JSON request containing the URL and metadata has a **1 MiB** budget. An over-limit declared body or parsing that exceeds this budget returns **HTTP 413**. The remotely downloaded file remains limited to **100 MiB**; an oversized remote file continues to return **HTTP 400**. Malformed JSON and invalid URLs also remain **HTTP 400**.

  ### Links

  - [Base64 upload](/en/api-reference/file-series/upload-base64)
  - [Multipart upload](/en/api-reference/file-series/upload-stream)
  - [URL upload](/en/api-reference/file-series/upload-url)

</Update>

<a id="2026-09-15-upload-content-isolation"></a>

<Update label="September 15, 2026" tags={["Platform"]} rss={{ title: "Upgrade guide: uploaded-content isolation" }}>
  ...
  - [Upgrade details](/en/api-reference/file-series/download)

</Update>

<a id="2026-09-15-subscription-overrun-debt"></a>

<Update label="September 15, 2026" tags={["Platform"]} rss={{ title: "Upgrade guide: subscription overrun and repayment" }}>
  ...
  - [Upgrade details](/en/faqs/account-billing)

</Update>

<a id="2026-09-15-payment-notification-validation"></a>

<Update label="September 15, 2026" tags={["Platform"]} rss={{ title: "Upgrade guide: payment notification validation" }}>
  ...
  - [Account and billing](/en/faqs/account-billing)

</Update>

<a id="2026-09-15-oauth-browser-binding"></a>

<Update label="September 15, 2026" tags={["Platform"]} rss={{ title: "Upgrade guide: browser-bound third-party login" }}>
  ...
  - [Upgrade details](/en/faqs/security)

</Update>

<a id="2026-09-15-device-approval-verification"></a>

<Update label="September 15, 2026" tags={["Platform"]} rss={{ title: "Upgrade guide: device approval security verification" }}>
  ...
  - [Upgrade details](/en/api-reference/account/device-login)
