...
<Update label="August 16, 2026" tags={["New models", "Audio", "Video"]} rss={{ title: "Index TTS voice clone plus LTX digital-human contract" }}>
  ...
  - **`ltx2.3-kj`** is a photo + audio lip-sync model. Prompt-only text-to-video examples were incorrect. Send image node `444` and audio node `1755`.

  ### Links

  - [Index TTS](/en/api-reference/audio-series/models/index-tts)
  - [LTX digital human](/en/api-reference/video-series/models/ltx2.3-kj)
