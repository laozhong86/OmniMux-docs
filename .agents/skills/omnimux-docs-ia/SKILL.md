...
4b. **`title` and `sidebarTitle` same human label** (preferred). Language Complete **must** keep brand on both: `Claude · 完整参数` / `Claude · Complete API Reference` — never bare `完整参数` in the sidebar.  
