...
3. Custom domain (recommended): `docs.geminix.cc` → CNAME `cname.mintlify.builders` (**DNS only / grey cloud** on Cloudflare)
...
```text
general_setting.docs_link = https://docs.geminix.cc
```
